...
public class DB {
    ...
    public static List<Person> getPersons(EntityManager em) {
        Query q = em.createQuery("select p from Person p order by p.firstName"); // reiskia kad pasiimsiu visus irasus irasus is lenteles kuri reprezentuoja klase Person; t.y. cia rasome ne lauku pavadinimus o properties pavadinimus klaseje!!
